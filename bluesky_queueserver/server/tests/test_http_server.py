...
import subprocess
import requests
from bluesky_queueserver.manager.tests.test_general import re_manager
...
def test_http_server_hello_handler(re_manager, aiohttp_server):
...
def test_http_server_queue_view_handler(re_manager, aiohttp_server):
    resp = _request_to_json('get', '/queue_view')
    assert resp['queue'] == []


def test_http_server_add_to_queue_handler(re_manager, aiohttp_server):
...
def test_http_server_pop_from_queue_handler(re_manager, aiohttp_server, add_plans_to_queue):
