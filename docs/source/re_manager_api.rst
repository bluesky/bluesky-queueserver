...
Returns       **msg**: *str*
              ...
              **manager_state**: *str*
                  ...
                  - **'run_list_uid'** - UID of the list of the active runs. Monitor this UID and
                    download the updated list of active runs once the UID is changed.
...
Description   Request the list of active runs generated by the currently executed plans.
              ...
              download the updated list once UID is changed. The UID of the downloaded list is
              included in the returned parameters
------------  -----------------------------------------------------------------------------------------
Parameters    **option**: *'active'*, *'open'* or *'stopped'* (optional)
                  select between full list of 'active' (default) runs, the list of 'open' or 'stopped'
                  runs.
------------  -----------------------------------------------------------------------------------------
Returns       **success**: *boolean*
                  indicates if the request was processed successfully.
