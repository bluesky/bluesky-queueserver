...
commands and HTTP API::
  ...
  http GET http://localhost:60610/re/runs/active  # Download the list of active runs
  http GET http://localhost:60610/re/runs/open    # Download the list of open runs
  http GET http://localhost:60610/re/runs/closed  # Download the list of closed runs
