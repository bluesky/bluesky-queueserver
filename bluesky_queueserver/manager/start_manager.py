...
def start_manager():
    ...
    group_console_output = parser.add_argument_group(
        ...
        "generated by RE Manager. By default, console output is printed in the terminal "
        "and published to 0MQ socket. The arguments allow to set the address of 0MQ socket "
        "(the default address is 'tcp://*:60625' and enable/disable printing and/or publishing "
    ...
    if zmq_publish_on:
        ...
        #   There is no need to wait if output is not published to 0MQ socket.
        ttime.sleep(1)
